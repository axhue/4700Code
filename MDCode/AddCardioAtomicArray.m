function AddCardioAtomicArray(LAtoms, WAtoms, X0, Y0, VX0, VY0, InitDist, Temp, Type)
global C
...
x_arr = linspace(0, L, LAtoms)
y_arr = linspace(0, W, WAtoms)
cardio = @(t) L*cos(t)

xp(1, :) = arrayfun(cardio,x_arr)
yp(1, :) = arrayfun(cardio,y_arr)
