...
Ep = 2;
AddParticleStream(5, 0.1, 10, -pi / 4, 1, 10*Ep * C.q_0, 5);
AddParticleStream(5, 3, 4, -pi / 10, 1, Ep * C.q_0, 5);
AddParticleStream(5, -3, 3, -pi / 2, 1, 5*Ep * C.q_0, 5);
AddParticleStream(5, 2, 1, -pi, 1, 2*Ep * C.q_0, 5);
Size = 10*AtomSpacing;
